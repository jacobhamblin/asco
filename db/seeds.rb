...
Following.create!({issuer_id: 1, recipient_id: 4})
Following.create!({issuer_id: 2, recipient_id: 3})
Following.create!({issuer_id: 2, recipient_id: 4})
Following.create!({issuer_id: 2, recipient_id: 5})
Following.create!({issuer_id: 3, recipient_id: 4})
Following.create!({issuer_id: 3, recipient_id: 1})
Following.create!({issuer_id: 3, recipient_id: 2})
Following.create!({issuer_id: 4, recipient_id: 1})
Following.create!({issuer_id: 4, recipient_id: 2})
Following.create!({issuer_id: 4, recipient_id: 3})
Following.create!({issuer_id: 5, recipient_id: 3})
Following.create!({issuer_id: 5, recipient_id: 1})
Following.create!({issuer_id: 5, recipient_id: 4})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/551066c32b5615c2108b45a1?width=800&dpi=1&sw=1855', curated: false, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
...
Image.create!({owner_id: 1, url: 'http://i.vsco.co/52d719e471670890390000ec?width=800&dpi=1&sw=1856', curated: true, description: 'Homero persius diceret eum no, homero pertinax usu ne, an graece petentium pro.'})
Image.create!({owner_id: 1, url: 'http://i.vsco.co/52fb0ef7726708ad7300018f?width=749&dpi=1&sw=1856', curated: true, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/55102d7be25515c31a8b4582?width=800&dpi=1&sw=1855', curated: false, description: 'Homero persius diceret eum no, homero pertinax usu ne, an graece petentium pro.'})
Image.create!({owner_id: 3, url: 'http://i.vsco.co/550c420ae355155f128b4567?width=800&dpi=1&sw=807', curated: false})
Image.create!({owner_id: 5, url: 'http://i.vsco.co/55122aed28561599498b4567?width=800&dpi=1&sw=1840', curated: false, description: 'Homero persius diceret eum no, homero pertinax usu ne, an graece petentium pro.'})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/5511a4ba2d561512468b457a?width=800&dpi=1&sw=1855', curated: false, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/551225ff295615a41e8b459d?width=800&dpi=1&sw=1855', curated: false, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/5511ec1608561556458b45a4?width=713&dpi=1&sw=1855', curated: false, description: 'Homero persius diceret eum no, homero pertinax usu ne, an graece petentium pro.'})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/55122ba52c5615bf6b8b457b?width=800&dpi=1&sw=1840', curated: false, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
...
Image.create!({owner_id: 5, url: 'http://i.vsco.co/5511db864556156d218b4568?width=800&dpi=1&sw=1855', curated: false})
Image.create!({owner_id: 5, url: 'http://i.vsco.co/55109bb30c5615f6298b4577?width=800&dpi=1&sw=1855', curated: false, description: 'Homero persius diceret eum no, homero pertinax usu ne, an graece petentium pro.'})
...
Image.create!({owner_id: 3, url: 'http://i.vsco.co/5338197f7267084f610001b4?width=800&dpi=1&sw=1856', curated: false, description: 'Usu et ancillae intellegam, ex ferri bonorum mandamus mel, amet velit integre no mea.'})
...
Image.create!({owner_id: 3, url: 'http://i.vsco.co/528cc5855a6808bc5600008f?width=800&dpi=1&sw=1871', curated: false, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
Image.create!({owner_id: 2, url: 'http://i.vsco.co/552cb191255615b9368b457a?width=800&dpi=1&sw=1871', curated: false, description: 'Homero persius diceret eum no, homero pertinax usu ne, an graece petentium pro.'})
Image.create!({owner_id: 3, url: 'http://i.vsco.co/55285bf0045615cd688b4571?width=800&dpi=1&sw=1856', curated: true, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
Image.create!({owner_id: 4, url: 'http://i.vsco.co/551427e52d5615c53d8b4585?width=800&dpi=1&sw=1840', curated: false})
Image.create!({owner_id: 5, url: 'http://i.vsco.co/55102bb4e3551577558b457f?width=800&dpi=1&sw=1855', curated: false, description: 'Lorem ipsum dolor sit amet, unum clita usu at, ea minim convenire sed.'})
Image.create!({owner_id: 5, url: 'http://i.vsco.co/551523b0045615d03c8b4570?width=800&dpi=1&sw=1871', curated: true, description: 'Usu et ancillae intellegam, ex ferri bonorum mandamus mel, amet velit integre no mea.'})
